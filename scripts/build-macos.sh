...
MPV_ENJOY_RELEASE_DIR="$MPV_ENJOY_BUILD_DIR/release/mpv-enjoy-1.1.3-$MPV_ENJOY_PLATFORM"
...
/usr/bin/hdiutil create \
    ...
    -ov \
    -format UDZO \
    "$MPV_ENJOY_DIST_DIR/mpv-enjoy-1.1.3-$MPV_ENJOY_PLATFORM.dmg"
/usr/bin/hdiutil verify "$MPV_ENJOY_DIST_DIR/mpv-enjoy-1.1.3-$MPV_ENJOY_PLATFORM.dmg"
python3 scripts/write_checksums.py "$MPV_ENJOY_DIST_DIR"

echo "macOS package: $MPV_ENJOY_DIST_DIR/mpv-enjoy-1.1.3-$MPV_ENJOY_PLATFORM.dmg"
