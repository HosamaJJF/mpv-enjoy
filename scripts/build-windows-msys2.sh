...
MPV_ENJOY_RELEASE_DIR="$MPV_ENJOY_BUILD_DIR/release/mpv-enjoy-1.1.6-windows-x64"
...
python3 scripts/make_zip.py \
    ...
    --output "$MPV_ENJOY_DIST_DIR/mpv-enjoy-1.1.6-windows-x64.zip"
python3 scripts/write_checksums.py "$MPV_ENJOY_DIST_DIR"

echo "Windows package: $MPV_ENJOY_DIST_DIR/mpv-enjoy-1.1.6-windows-x64.zip"
